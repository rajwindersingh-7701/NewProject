...
class Cron extends CI_Controller
{
        ...
        foreach ($roi_users as $key => $user) {
            ...
            if ($diff >= 0) {
                ...
                if ($userinfo['roi_income'] == 0) {
                    ...
                    $roi_amount2 = $user['roi_amount'] / $daysInMonth;
    ...
    {
        // if(date('D') == 'Sun'){
        $response['users'] = get_records('tbl_users', '(leftPower >= 2 and rightPower >= 1 and directs >= 2) OR (leftPower >= 1 and rightPower >= 2  and directs >= 2)', '*');
